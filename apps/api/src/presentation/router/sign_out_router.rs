...
use crate::{
    application::usecase::sign_out_usecase::SignOutInput,
    presentation::{
        handler::sign_out_handler::SignOutHandler, middleware::json_validator::JsonValidator,
    },
};
    ...
    pub fn routes(&self) -> Router {
        Router::new().route(
            ...
            post({
                ...
                move |input: JsonValidator<SignOutInput>| {
...
mod tests {
    ...
    //     test_support::{build_confirm_sign_up_router, build_db_connection, set_up, tear_down},
    // };

    // #[tokio::test]
    // async fn test_confirm_sign_up_router() {
    //     set_up().await;

    //     let router = build_confirm_sign_up_router().await;
